...
<body>
    ...
    <div class="container main-content">
        ...
        <p>Welcome to the Event Management Page. Please select an option to manage your events:</p>
        <a href="InsertEvent.jsp" class="btn">Insert Event</a>
        <a href="UpdateEvent.jsp" class="btn">Update Event</a>
        <a href="ReadEvent.jsp" class="btn">View Events</a>
        <a href="DeleteEvent.jsp" class="btn">Delete Events</a>
    </div>
